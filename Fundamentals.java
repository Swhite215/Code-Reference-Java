public class Fundamentals {
    ...
    public static void main(String[] args) {
        ...
        ; // Sixteen Digits of Precision, 8 Bytes
        ...
        // Reference Types - Holds address to object in memory, use new for unique...
        int[] myIntArray = new int[5];
        int[] anotherIntArray = myIntArray;

        System.out.println(Array.toString(myIntArray));
        System.out.println(Array.toString(anotherIntArray));

        anotherIntArray[0] = 10; // This will change myIntArray[0]
